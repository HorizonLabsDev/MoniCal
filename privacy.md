...
## 4. Analysedaten
MoniCal verwendet keine Analyse-, Tracking- oder Werbedienste. Es werden keine Nutzungsdaten erhoben.

## 5. Crash-Berichte
Falls du der Übermittlung von Absturzberichten in deinen iOS-Einstellungen zugestimmt hast, können anonymisierte Berichte über Apple an uns weitergeleitet werden. Diese enthalten keine personenbezogenen Daten.

## 6. Deine Rechte
Da wir keine personenbezogenen Daten erheben oder verarbeiten, fallen keine Auskunfts-, Lösch- oder Widerspruchsrechte gegenüber uns an. Für Fragen erreichst du uns unter: horizonlabs.dev@gmail.com

## 7. Änderungen
Wir behalten uns vor, diese Datenschutzerklärung zu aktualisieren. Die jeweils aktuelle Version ist in der App und unter https://horizonlabsdev.github.io/MoniCal/privacy abrufbar.
...
## 4. Analytics
MoniCal does not use any analytics, tracking, or advertising services. No usage data is collected.

## 5. Crash Reports
If you have consented to crash report submission in your iOS settings, anonymised reports may be forwarded to us via Apple. These do not contain personal data.

## 6. Your rights
Since we do not collect or process personal data, no rights of access, deletion, or objection arise against us. For questions, contact us at: horizonlabs.dev@gmail.com
